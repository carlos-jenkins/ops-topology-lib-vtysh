...
project = 'Vtysh Communication Library for Topology'
...
htmlhelp_basename = 'topology_lib_vtyshdoc'
...
latex_documents = [
    (
        'index', 'topology_lib_vtysh.tex',
        'Vtysh Communication Library for Topology Documentation',
